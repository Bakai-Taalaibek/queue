...
import { clientsCounter, canceledClientsCounter } from "@/utils/utils";
...
const RegistrarHome = () => {
  ...
  const restoreTalon = useRegistrar((state) => state.restoreTalon);
  

  const isDarkMode = useMain((state) => state.isDarkMode);

  const handleRestoreTalon = async (talon) => {
   try {
     await restoreTalon(talon.token);
     await getTalons();
   } catch (error) {
     console.log(error);
   }
  ...
  const tableContent = (talon) => (
    <div className={styles.tableContent}>
      <div onClick={() => handleRestoreTalon(talon)}>Восстановить</div>
  ...
  const filteredTalons = talons
    ? talons.filter((talon) => talon.token.includes(searchValue))
    : [];
          ...
          <div className={styles.cardBlock}>
            <div
              ...
              <div className={styles.body}>
                ...
                <p style={{ color: isDarkMode && "#A0FF9E" }}>
                  {t("card.body")}
                </p>
              </div>
            ...
            <div
              ...
              <div className={styles.body}>
                <div style={{ backgroundColor: isDarkMode && "#712828" }}>
                  <img
                    src={isDarkMode ? darkModeArrowRed : arrowRed}
                    alt="arrow"
                  />
                ...
                <p style={{ color: isDarkMode && "#FFC8D0" }}>
                  {t("card.body")}
                </p>
              </div>
              <div className={styles.footer}>
